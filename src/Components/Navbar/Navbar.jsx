  ...
  return (
    <header className='headerNav'>
        ...
        <nav className='navBarMain'>
            ...
            <p id='caracteristicasButton' className='navLinks'><Link to="Caracteristicas" spy={true} smooth={true} offstet={50} duration={500} ><button className='navButton'>LOG IN</button></Link></p>
